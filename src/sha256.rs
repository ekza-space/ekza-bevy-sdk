//! Dependency-free SHA-256 (FIPS 180-4) used to verify downloaded renditions.
//!
//! Kept in-crate so the engine-agnostic core carries no crypto dependency
//! tree; verified against the FIPS test vectors in the tests below.
...
/// Lowercase hex SHA-256 of `bytes`, the form used in every Ekza feed.
